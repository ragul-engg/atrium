...
class FeatureExtractorSamples {
    ...
    fun itsFeature() {
        ...
        expect(person) its { age } toBeLessThan 30 toBeGreaterThan 20 // subject is now Int


        fails {
            expect(person) its { age } toBeLessThan 20 toBeGreaterThan 30 // subject is now Int; fails
        }
    }
    ...
    fun featureFromPropertyFeature() {
        ...
        expect(person) feature Person::name toStartWith "John" toEndWith "Smith" // subject is now String

        fails {
            expect(person) feature Person::name toStartWith "Kevin" toEndWith "Bacon" //fails
        }
    }
    ...
    fun featureFromFunctionFeature() {
        ...
        expect(person) feature ::f toStartWith "John" toEndWith "Smith" // subject is now of type String

        fails {
            expect(person) feature ::f toStartWith "Kevin" toEndWith "Bacon" // fails
    ...
    fun featureWithMetaFeatureProviderFeature() {
        ...
        fails {
            expect(person) feature { f(it::age) } toBeGreaterThan 30 toBeLessThan 20  // fails
        }
    }
